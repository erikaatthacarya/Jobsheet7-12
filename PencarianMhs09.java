public class PencarianMhs09 {
    ...
    public PencarianMhs09(int jumMhs){
    ...
    public void TampilposisiNama(String cari, int pos) {
        if (pos != -1) {
    ...
    public int FindBinarySearchName(String cari, int i, int j, int k) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'FindBinarySearchName'");
    }
}
